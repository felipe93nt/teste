...
public class ClienteGuilhermeVO implements Comparable<ClienteGuilhermeVO> {
	...
	public ClienteGuilhermeVO(){
		
	}
	
	
	
	public ClienteGuilhermeVO(String nome, String cpf, String rg,
	...
	@Override
	public int compareTo(ClienteGuilhermeVO o) {
		return 0;
	}
