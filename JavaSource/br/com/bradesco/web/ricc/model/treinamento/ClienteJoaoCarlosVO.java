...
public class ClienteJoaoCarlosVO implements Comparable<ClienteJoaoCarlosVO> {
	...
	public ClienteJoaoCarlosVO() {
	}

	public ClienteJoaoCarlosVO(String nome, String cpf, String rg,
	...
	@Override
	public int compareTo(ClienteJoaoCarlosVO o) {
		return 0;
	}
