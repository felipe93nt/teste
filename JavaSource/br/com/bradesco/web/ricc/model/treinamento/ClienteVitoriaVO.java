...
public class ClienteVitoriaVO implements Comparable<ClienteVitoriaVO> {
	...
	public ClienteVitoriaVO(){
		
	}

	public ClienteVitoriaVO(String nome, String cpf, String rg,
	...
	@Override
	public int compareTo(ClienteVitoriaVO o) {
