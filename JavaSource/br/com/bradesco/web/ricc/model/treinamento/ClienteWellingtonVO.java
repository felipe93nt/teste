...
public class ClienteWellingtonVO implements Comparable<ClienteWellingtonVO>{
	...
	public ClienteWellingtonVO() {
	}
	
	public ClienteWellingtonVO(String nomeCompleto, String cpf, String rg,
	...
	@Override
	public int compareTo(ClienteWellingtonVO o) {
