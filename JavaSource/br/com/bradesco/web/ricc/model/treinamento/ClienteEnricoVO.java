...
public class ClienteEnricoVO implements Comparable<ClienteEnricoVO>{
	...
	public ClienteEnricoVO() {
		
	}
	
	public ClienteEnricoVO(String nome, String cpf, String rg,
	...
	@Override
	public int compareTo(ClienteEnricoVO o) {
		return 0;
	}
