...
/**
 * Nome: RICCWBXERequestRegistroAreaEntrada 
 * Propósito: Classe gerada automaticamente a partir de um xsd
 ...
 * @see: NA.
 */
public class RICCWBXERequestRegistroAreaEntrada extends AnnotatedAdapter {

    /**
     * Atributo ncustoOper
     */
    @CommareaField(name = {"RICCWBXE-REGISTRO", "RICCWBXE-AREA-ENTRADA", "RICCWBXE-NCUSTO-OPER"},
     ...
     * Atributo nanoCusto
     */
    @CommareaField(name = {"RICCWBXE-REGISTRO", "RICCWBXE-AREA-ENTRADA", "RICCWBXE-NANO-CUSTO"}, maxLength = 4,
     ...
     * Atributo pcustCombs
     */
    @CommareaField(name = {"RICCWBXE-REGISTRO", "RICCWBXE-AREA-ENTRADA", "RICCWBXE-PCUST-COMBS"},
     ...
     */
    @CommareaField(name = {"RICCWBXE-REGISTRO", "RICCWBXE-AREA-ENTRADA", "RICCWBXE-PCUST-COMBS-N"},
     ...
     */
    @CommareaField(name = {"RICCWBXE-REGISTRO", "RICCWBXE-AREA-ENTRADA", "RICCWBXE-PCUST-MDOBRA"},
     ...
     */
    @CommareaField(name = {"RICCWBXE-REGISTRO", "RICCWBXE-AREA-ENTRADA", "RICCWBXE-PCUST-MDOBRA-N"},
     ...
     */
    @CommareaField(name = {"RICCWBXE-REGISTRO", "RICCWBXE-AREA-ENTRADA", "RICCWBXE-PCUST-OUTROS"},
     ...
     */
    @CommareaField(name = {"RICCWBXE-REGISTRO", "RICCWBXE-AREA-ENTRADA", "RICCWBXE-PCUST-OUTROS-N"},
     ...
     * Atributo pcustTotal
     */
    @CommareaField(name = {"RICCWBXE-REGISTRO", "RICCWBXE-AREA-ENTRADA", "RICCWBXE-PCUST-TOTAL"},
     ...
     */
    @CommareaField(name = {"RICCWBXE-REGISTRO", "RICCWBXE-AREA-ENTRADA", "RICCWBXE-PCUST-TOTAL-N"},
     ...
     * @see
     */
    public RICCWBXERequestRegistroAreaEntrada() {
        super();
    }
}
