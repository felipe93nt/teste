 ...
 * @see: NA.
 */
public class RICCWAFERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWAFE-HEADER", "RICCWAFE-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWAFE";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWAFE-HEADER", "RICCWAFE-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAFE-REGISTRO", "RICCWAFE-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWAFE-REGISTRO", "RICCWAFE-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAFE-REGISTRO", "RICCWAFE-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAFE-REGISTRO", "RICCWAFE-NRELAT-SGMTO"}, maxLength = 9, usage = "DISPLAY",
