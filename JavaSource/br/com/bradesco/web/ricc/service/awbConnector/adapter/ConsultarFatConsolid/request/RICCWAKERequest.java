 ...
 * @see: NA.
 */
public class RICCWAKERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWAKE-HEADER", "RICCWAKE-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWAKE";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWAKE-HEADER", "RICCWAKE-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAKE-REGISTRO", "RICCWAKE-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWAKE-REGISTRO", "RICCWAKE-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAKE-REGISTRO", "RICCWAKE-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAKE-REGISTRO", "RICCWAKE-NRELAT-SGMTO"}, maxLength = 9, usage = "DISPLAY",
