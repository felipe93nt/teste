 ...
 * @see: NA.
 */
public class RICCWA2ERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWA2E-HEADER", "RICCWA2E-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWA2E";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWA2E-HEADER", "RICCWA2E-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWA2E-REGISTRO", "RICCWA2E-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo maxOcorr
     */
    @CommareaField(name = {"RICCWA2E-REGISTRO", "RICCWA2E-MAX-OCORR"}, maxLength = 5, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWA2E-REGISTRO", "RICCWA2E-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWA2E-REGISTRO", "RICCWA2E-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
    ...
    /**
     * Propósito:  Retornar o valor de fILLER6
     *
     * @return fILLER6
     */
    ...
    /**
     * Propósito:  Atribuir valor ao fILLER6
     *
     * @param value novo valor a ser atribuido para o campo 
     */
