 ...
 * @see: NA.
 */
public class RICCWAJERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWAJE-HEADER", "RICCWAJE-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWAJE";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWAJE-HEADER", "RICCWAJE-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAJE-REGISTRO", "RICCWAJE-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo maxOcorr
     */
    @CommareaField(name = {"RICCWAJE-REGISTRO", "RICCWAJE-MAX-OCORR"}, maxLength = 5, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWAJE-REGISTRO", "RICCWAJE-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAJE-REGISTRO", "RICCWAJE-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAJE-REGISTRO", "RICCWAJE-NRELAT-SGMTO"}, maxLength = 9, usage = "DISPLAY",
