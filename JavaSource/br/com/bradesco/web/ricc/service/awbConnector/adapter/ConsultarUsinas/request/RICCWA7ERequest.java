 ...
 * @see: NA.
 */
public class RICCWA7ERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWA7E-HEADER", "RICCWA7E-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWA7E";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWA7E-HEADER", "RICCWA7E-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWA7E-REGISTRO", "RICCWA7E-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWA7E-REGISTRO", "RICCWA7E-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWA7E-REGISTRO", "RICCWA7E-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
