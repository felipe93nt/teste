 ...
 * @see: NA.
 */
public class RICCWAMERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWAME-HEADER", "RICCWAME-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWAME";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWAME-HEADER", "RICCWAME-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAME-REGISTRO", "RICCWAME-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWAME-REGISTRO", "RICCWAME-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAME-REGISTRO", "RICCWAME-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAME-REGISTRO", "RICCWAME-NRELAT-SGMTO"}, maxLength = 9, usage = "DISPLAY",
     ...
     * Atributo filler32
     */
    protected String filler32 = null;
    ...
    /**
     * Propósito:  Retornar o valor de fILLER32
     *
     * @return fILLER32
     */
    ...
    /**
     * Propósito:  Atribuir valor ao fILLER32
     *
     * @param value novo valor a ser atribuido para o campo 
     */
