...
/**
 * Nome: RICCWBWERequestRegistroAreaEntrada 
 * Propósito: Classe gerada automaticamente a partir de um xsd
 ...
 * @see: NA.
 */
public class RICCWBWERequestRegistroAreaEntrada extends AnnotatedAdapter {

    /**
     * Atributo ntrnspCarga
     */
    @CommareaField(name = {"RICCWBWE-REGISTRO", "RICCWBWE-AREA-ENTRADA", "RICCWBWE-NTRNSP-CARGA"},
     ...
     * Atributo nanoFrota
     */
    @CommareaField(name = {"RICCWBWE-REGISTRO", "RICCWBWE-AREA-ENTRADA", "RICCWBWE-NANO-FROTA"}, maxLength = 4,
     ...
     * Atributo pfrtPpria
     */
    @CommareaField(name = {"RICCWBWE-REGISTRO", "RICCWBWE-AREA-ENTRADA", "RICCWBWE-PFRT-PPRIA"}, maxLength = 5,
     ...
     * Atributo pfrtPpriaN
     */
    @CommareaField(name = {"RICCWBWE-REGISTRO", "RICCWBWE-AREA-ENTRADA", "RICCWBWE-PFRT-PPRIA-N"},
     ...
     * Atributo pfrtAgrdos
     */
    @CommareaField(name = {"RICCWBWE-REGISTRO", "RICCWBWE-AREA-ENTRADA", "RICCWBWE-PFRT-AGRDOS"},
     ...
     */
    @CommareaField(name = {"RICCWBWE-REGISTRO", "RICCWBWE-AREA-ENTRADA", "RICCWBWE-PFRT-AGRDOS-N"},
     ...
     * Atributo pfrtTceros
     */
    @CommareaField(name = {"RICCWBWE-REGISTRO", "RICCWBWE-AREA-ENTRADA", "RICCWBWE-PFRT-TCEROS"},
     ...
     */
    @CommareaField(name = {"RICCWBWE-REGISTRO", "RICCWBWE-AREA-ENTRADA", "RICCWBWE-PFRT-TCEROS-N"},
     ...
     * @see
     */
    public RICCWBWERequestRegistroAreaEntrada() {
        super();
    }
}
