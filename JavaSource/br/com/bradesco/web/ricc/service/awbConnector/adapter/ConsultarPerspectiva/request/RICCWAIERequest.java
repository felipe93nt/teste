 ...
 * @see: NA.
 */
public class RICCWAIERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWAIE-HEADER", "RICCWAIE-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWAIE";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWAIE-HEADER", "RICCWAIE-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAIE-REGISTRO", "RICCWAIE-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWAIE-REGISTRO", "RICCWAIE-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAIE-REGISTRO", "RICCWAIE-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAIE-REGISTRO", "RICCWAIE-NRELAT-SGMTO"}, maxLength = 9, usage = "DISPLAY",
