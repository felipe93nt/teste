 ...
 * @see: NA.
 */
public class RICCWAGERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWAGE-HEADER", "RICCWAGE-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWAGE";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWAGE-HEADER", "RICCWAGE-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAGE-REGISTRO", "RICCWAGE-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWAGE-REGISTRO", "RICCWAGE-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAGE-REGISTRO", "RICCWAGE-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAGE-REGISTRO", "RICCWAGE-NRELAT-SGMTO"}, maxLength = 9, usage = "DISPLAY",
     ...
     * Atributo filler20
     */
    protected String filler20 = null;
    ...
    /**
     * Propósito:  Retornar o valor de fILLER20
     *
     * @return fILLER20
     */
    ...
    /**
     * Propósito:  Atribuir valor ao fILLER20
     *
     * @param value novo valor a ser atribuido para o campo 
     */
