 ...
 * @see: NA.
 */
public class RICCWAXERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWAXE-HEADER", "RICCWAXE-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWAXE";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWAXE-HEADER", "RICCWAXE-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAXE-REGISTRO", "RICCWAXE-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo maxOcorr
     */
    @CommareaField(name = {"RICCWAXE-REGISTRO", "RICCWAXE-MAX-OCORR"}, maxLength = 5, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWAXE-REGISTRO", "RICCWAXE-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAXE-REGISTRO", "RICCWAXE-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
     ...
     * Atributo ctpoQuadr
     */
    @CommareaField(name = {"RICCWAXE-REGISTRO", "RICCWAXE-CTPO-QUADR"}, maxLength = 1, usage = "DISPLAY",
