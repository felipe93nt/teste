 ...
 * @see: NA.
 */
public class RICCWAZERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWAZE-HEADER", "RICCWAZE-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWAZE";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWAZE-HEADER", "RICCWAZE-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAZE-REGISTRO", "RICCWAZE-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo maxOcorr
     */
    @CommareaField(name = {"RICCWAZE-REGISTRO", "RICCWAZE-MAX-OCORR"}, maxLength = 5, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWAZE-REGISTRO", "RICCWAZE-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAZE-REGISTRO", "RICCWAZE-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
     ...
     * Atributo filler0
     */
    @CommareaField(name = {"RICCWAZE-REGISTRO", "FILLER"}, maxLength = 61, usage = "DISPLAY", fieldNumber = 6,
        maxBytes = 61, pic = "X(061)")
