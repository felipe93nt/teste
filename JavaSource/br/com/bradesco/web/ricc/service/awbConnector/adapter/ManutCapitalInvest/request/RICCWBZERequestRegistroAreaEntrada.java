...
/**
 * Nome: RICCWBZERequestRegistroAreaEntrada 
 * Propósito: Classe gerada automaticamente a partir de um xsd
 ...
 * @see: NA.
 */
public class RICCWBZERequestRegistroAreaEntrada extends AnnotatedAdapter {

    /**
     * Atributo ncaptlInves
     */
    @CommareaField(name = {"RICCWBZE-REGISTRO", "RICCWBZE-AREA-ENTRADA", "RICCWBZE-NCAPTL-INVES"},
     ...
     * Atributo nanoCaptl
     */
    @CommareaField(name = {"RICCWBZE-REGISTRO", "RICCWBZE-AREA-ENTRADA", "RICCWBZE-NANO-CAPTL"}, maxLength = 4,
     ...
     */
    @CommareaField(name = {"RICCWBZE-REGISTRO", "RICCWBZE-AREA-ENTRADA", "RICCWBZE-RECURSOS-PROPRIO", "RICCWBZ"
        + "E-VRECRS-PPRIO-S"}, maxLength = 1, usage = "DISPLAY", fieldNumber = 2, maxBytes = 1,
        pic = "X(001)")
     ...
     */
    @CommareaField(name = {"RICCWBZE-REGISTRO", "RICCWBZE-AREA-ENTRADA", "RICCWBZE-RECURSOS-PROPRIO", "RICCWBZ"
        + "E-VRECRS-PPRIO"}, maxLength = 17, usage = "DISPLAY", fieldNumber = 3, maxBytes = 17, pic = "9(015)"
        + "V99")
     ...
     */
    @CommareaField(name = {"RICCWBZE-REGISTRO", "RICCWBZE-AREA-ENTRADA", "RICCWBZE-RECURSOS-PROPRIO", "RICCWBZ"
        + "E-VRECRS-PPRIO-N"}, maxLength = 1, usage = "DISPLAY", fieldNumber = 4, maxBytes = 1,
        pic = "X(001)")
     ...
     */
    @CommareaField(name = {"RICCWBZE-REGISTRO", "RICCWBZE-AREA-ENTRADA", "RICCWBZE-RECURSOS-TERCEIRO", "RICCWB"
        + "ZE-VRECRS-TCERO-S"}, maxLength = 1, usage = "DISPLAY", fieldNumber = 5, maxBytes = 1, pic = "X(001"
        + ")")
     ...
     */
    @CommareaField(name = {"RICCWBZE-REGISTRO", "RICCWBZE-AREA-ENTRADA", "RICCWBZE-RECURSOS-TERCEIRO", "RICCWB"
        + "ZE-VRECRS-TCERO"}, maxLength = 17, usage = "DISPLAY", fieldNumber = 6, maxBytes = 17, pic = "9(015"
        + ")V99")
     ...
     */
    @CommareaField(name = {"RICCWBZE-REGISTRO", "RICCWBZE-AREA-ENTRADA", "RICCWBZE-RECURSOS-TERCEIRO", "RICCWB"
        + "ZE-VRECRS-TCERO-N"}, maxLength = 1, usage = "DISPLAY", fieldNumber = 7, maxBytes = 1, pic = "X(001"
        + ")")
     ...
     * @see
     */
    public RICCWBZERequestRegistroAreaEntrada() {
        super();
    }
}
