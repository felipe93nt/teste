 ...
 * @see: NA.
 */
public class RICCWAWERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWAWE-HEADER", "RICCWAWE-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWAWE";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWAWE-HEADER", "RICCWAWE-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAWE-REGISTRO", "RICCWAWE-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo maxOcorr
     */
    @CommareaField(name = {"RICCWAWE-REGISTRO", "RICCWAWE-MAX-OCORR"}, maxLength = 5, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWAWE-REGISTRO", "RICCWAWE-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWAWE-REGISTRO", "RICCWAWE-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
     ...
     * Atributo ctpoFornc
     */
    @CommareaField(name = {"RICCWAWE-REGISTRO", "RICCWAWE-CTPO-FORNC"}, maxLength = 2, usage = "DISPLAY",
