 ...
 * @see: NA.
 */
public class RICCWA1ERequest extends AnnotatedAdapter {

    /**
     * Atributo codLayout
     */
    @CommareaField(name = {"RICCWA1E-HEADER", "RICCWA1E-COD-LAYOUT"}, maxLength = 8, usage = "DISPLAY",
        fieldNumber = 0, maxBytes = 8, pic = "X(008)")
    protected String codLayout = "RICCWA1E";

    /**
     * Atributo tamLayout
     */
    @CommareaField(name = {"RICCWA1E-HEADER", "RICCWA1E-TAM-LAYOUT"}, maxLength = 5, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWA1E-REGISTRO", "RICCWA1E-NVERSAO-ORIGE"}, maxLength = 3, usage = "DISPLAY",
     ...
     * Atributo maxOcorr
     */
    @CommareaField(name = {"RICCWA1E-REGISTRO", "RICCWA1E-MAX-OCORR"}, maxLength = 5, usage = "DISPLAY",
     ...
     * Atributo cgrpEconm
     */
    @CommareaField(name = {"RICCWA1E-REGISTRO", "RICCWA1E-CGRP-ECONM"}, maxLength = 9, usage = "DISPLAY",
     ...
     */
    @CommareaField(name = {"RICCWA1E-REGISTRO", "RICCWA1E-NRELAT-CREDT"}, maxLength = 9, usage = "DISPLAY",
