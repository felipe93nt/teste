...
/**
 * Nome: RICCWATSResponseRegistroAreaSaida 
 * Propósito: Classe gerada automaticamente a partir de um xsd
 ...
 * @see: NA.
 */
public class RICCWATSResponseRegistroAreaSaida extends AnnotatedAdapter {

    /**
     * Atributo nreajsTrnsp
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-NREAJS-TRNSP"}, maxLength = 2,
     ...
     * Atributo nanoTrsp
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-NANO-TRSP"}, maxLength = 4,
     ...
     * Atributo ptranMuncp
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-PTRAN-MUNCP"}, maxLength = 5,
     ...
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-PTRAN-MUNCP-N"},
     ...
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-PTRAN-IMUNCP"}, maxLength = 5,
     ...
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-PTRAN-IMUNCP-N"},
     ...
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-PTRAN-IESTAD"}, maxLength = 5,
     ...
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-PTRAN-IESTAD-N"},
     ...
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-PTRAN-INACIO"}, maxLength = 5,
     ...
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-PTRAN-INACIO-N"},
     ...
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-PTRAN-FRTMTO"}, maxLength = 5,
     ...
     */
    @CommareaField(name = {"RICCWATS-REGISTRO", "RICCWATS-AREA-SAIDA", "RICCWATS-PTRAN-FRTMTO-N"},
     ...
     * @see
     */
    public RICCWATSResponseRegistroAreaSaida() {
        super();
    }
}
