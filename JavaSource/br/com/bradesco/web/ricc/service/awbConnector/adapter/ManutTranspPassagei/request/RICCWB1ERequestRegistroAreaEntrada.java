...
/**
 * Nome: RICCWB1ERequestRegistroAreaEntrada 
 * Propósito: Classe gerada automaticamente a partir de um xsd
 ...
 * @see: NA.
 */
public class RICCWB1ERequestRegistroAreaEntrada extends AnnotatedAdapter {

    /**
     * Atributo ncontrEmpr
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-NCONTR-EMPR"},
     ...
     * Atributo nanoContr
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-NANO-CONTR"}, maxLength = 4,
     ...
     * Atributo pperformar
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-PPERFORMAR"}, maxLength = 5,
     ...
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-PPERFORMAR-N"},
     ...
     * Atributo ptakePay
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-PTAKE-PAY"}, maxLength = 5,
     ...
     * Atributo ptakePayN
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-PTAKE-PAY-N"},
     ...
     * Atributo plocacao
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-PLOCACAO"}, maxLength = 5,
     ...
     * Atributo plocacaoN
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-PLOCACAO-N"}, maxLength = 1,
     ...
     * Atributo pspot
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-PSPOT"}, maxLength = 5,
     ...
     * Atributo pspotN
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-PSPOT-N"}, maxLength = 1,
     ...
     * Atributo ptotal
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-PTOTAL"}, maxLength = 5,
     ...
     * Atributo ptotalN
     */
    @CommareaField(name = {"RICCWB1E-REGISTRO", "RICCWB1E-AREA-ENTRADA", "RICCWB1E-PTOTAL-N"}, maxLength = 1,
     ...
     * @see
     */
    public RICCWB1ERequestRegistroAreaEntrada() {
        super();
    }
}
