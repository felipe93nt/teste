...
public class DetalharMensagemViewHelper extends AbstractViewHelper {
	private static final long serialVersionUID = 4201953050604850242L;

	private Boolean renderModalImprimir = Boolean.FALSE;
	...
	private String textArea57 = "*ABN AMRO ABNK N.V.\n*AMSTERDAM";
	...
	public Boolean getRenderModalImprimir() {
		return renderModalImprimir;
	}

	public void setRenderModalImprimir(Boolean renderModalImprimir) {
		this.renderModalImprimir = renderModalImprimir;
	}
