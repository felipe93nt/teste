...
import br.com.bradesco.web.ricc.view.bean.parametrizacaomensagem.viewhelper.AlterarFormatoMensagemViewHelper;

/**
 * @name AlterarFormatoMensagemBean
 * @author Foursys
 * @version 1.0
 * @since 26/06/2020
 */
@SessionScoped
@Named(value = "alterarFormatoMensagemBean")
public class AlterarFormatoMensagemBean extends
		AbstractBean<AlterarFormatoMensagemViewHelper> {
	...
	public String iniciarPagina() {
		setViewHelper(new AlterarFormatoMensagemViewHelper());
		viewHelper.inicializar();
		carregarCamposIntegrantesVO();
		carregarCamposVO();
		return RiccConstants.TELA_PARAMETRIZACAO_ALTERAR_FORMATOS_MENSAGEM;
	}
