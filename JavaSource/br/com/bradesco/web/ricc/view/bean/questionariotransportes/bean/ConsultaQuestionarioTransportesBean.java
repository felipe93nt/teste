...
import br.com.bradesco.web.ricc.view.bean.questionariotransportes.viewhelper.ConsultaQuestionarioTransportesViewHelper;

@SessionScoped
@Named(value = "consultaQuestionarioTransportesBean")
public class ConsultaQuestionarioTransportesBean extends AbstractBean<ConsultaQuestionarioTransportesViewHelper> {
	...
	public String iniciarPagina() {
		setViewHelper(new ConsultaQuestionarioTransportesViewHelper());
		viewHelper.inicializar(); 
		
		return RiccConstants.TELA_CONSULTA_QUESTIONARIO_TRANSPORTES;
	}
