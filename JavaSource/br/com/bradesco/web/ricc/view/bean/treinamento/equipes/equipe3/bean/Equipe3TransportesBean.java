...
import br.com.bradesco.web.ricc.view.bean.treinamento.equipes.equipe3.viewhelper.Equipe3TransportesViewHelper;
 ...
 */
@SessionScoped
@Named(value = "equipe3BeanTransportes")
public class Equipe3TransportesBean extends
		AbstractBean<Equipe3TransportesViewHelper> {

	private static final long serialVersionUID = 7812957486456093017L;

	private ConsultaQuestionarioTransportesViewHelper consultaQuestionarioTransportesViewHelper = new ConsultaQuestionarioTransportesViewHelper();

	public ConsultaQuestionarioTransportesViewHelper getConsultaQuestionarioTransportesViewHelper() {
		return consultaQuestionarioTransportesViewHelper;
	}

	public void setConsultaQuestionarioTransportesViewHelper(
			ConsultaQuestionarioTransportesViewHelper consultaQuestionarioTransportesViewHelper) {
		this.consultaQuestionarioTransportesViewHelper = consultaQuestionarioTransportesViewHelper;
	}
	...
	public String iniciarPagina() {
		setViewHelper(new Equipe3TransportesViewHelper());
		viewHelper.inicializar();

		return RiccConstants.TELA_CONSULTA_QUESTIONARIO_TRANSPORTE_EQUIPE3;
	}
