...
import br.com.bradesco.web.ricc.view.bean.questionarioagronegocio.viewhelper.ConsultaQuestionarioAgronegocioViewHelper;

@SessionScoped
@Named(value = "consultaQuestionarioAgronegocioBean")
public class ConsultaQuestionarioAgronegocioBean extends AbstractBean<ConsultaQuestionarioAgronegocioViewHelper> {
	...
	public String iniciarPagina() {
		...
		setViewHelper(new ConsultaQuestionarioAgronegocioViewHelper());
		viewHelper.inicializar();
		
		return RiccConstants.TELA_CONSULTA_QUESTIONARIO_AGRONEGOCIO;
	}
