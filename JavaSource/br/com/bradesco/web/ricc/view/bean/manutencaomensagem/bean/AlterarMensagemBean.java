...
import br.com.bradesco.web.ricc.view.bean.manutencaomensagem.viewhelper.IncluirMensagemViewHelper;

/**
 * @name AlterarMensagemBean
 * @author Foursys
 * @version 1.0
 * @since 08/06/2020
 */
@SessionScoped
@Named(value = "alterarMensagemBean")
public class AlterarMensagemBean extends
		AbstractBean<IncluirMensagemViewHelper> {
	/**
	...
	public String iniciarPagina() {
		setViewHelper(new IncluirMensagemViewHelper());
		...
		return RiccConstants.TELA_MANUTENCAO_ALTERAR_MENSAGEM;
	}
