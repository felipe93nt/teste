...
@SessionScoped
@Named(value = "consultaQuestionarioEmpresasBean")
public class ConsultaQuestionarioEmpresasBean extends
		AbstractBean<ConsultaQuestionarioEmpresasViewHelper> {
	...
	public String iniciarPagina() {
		carregarDados();
		return RiccConstants.TELA_CONSULTA_QUESTIONARIO_EMPRESAS;
	}
...
//	}
	...
	public String consultarSetor() {
		try {
			...
			String retorno = "";
			String paginaAnterior = RiccConstants.TELA_CONSULTA_QUESTIONARIO_EMPRESAS;
