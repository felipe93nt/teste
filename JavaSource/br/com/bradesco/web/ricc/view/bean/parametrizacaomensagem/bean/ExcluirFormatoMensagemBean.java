...
import br.com.bradesco.web.ricc.view.bean.parametrizacaomensagem.viewhelper.ExcluirFormatoMensagemViewHelper;

/**
 * @name ExcluirFormatoMensagemBean
 * @author Foursys
 * @version 1.0
 * @since 26/06/2020
 */
@SessionScoped
@Named(value = "excluirFormatoMensagemBean")
public class ExcluirFormatoMensagemBean extends
		AbstractBean<ExcluirFormatoMensagemViewHelper> {
	...
	public String iniciarPagina() {
		setViewHelper(new ExcluirFormatoMensagemViewHelper());
		viewHelper.inicializar();
		carregarCamposIntegrantesVO();
		carregarCamposVO();
		return RiccConstants.TELA_PARAMETRIZACAO_EXCLUIR_FORMATOS_MENSAGEM;
	}
	...
	public void carregarCamposIntegrantesVO() {
		...
		c5.setCampo("108 Message User Reference");
		...
		c6.setCampo("119 Validation Flag");
		...
		c7.setCampo("111 Service Type Identifier");
		...
		c8.setCampo("121 Unique End-to-End Tr.Ref.");
		...
		c9.setObrigatorio("");
		c9.setOrdem("009");
		viewHelper.getListaCamposIntegrantesVO().add(c9);
	}
