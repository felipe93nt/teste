...
import br.com.bradesco.web.ricc.view.bean.permissoes.viewhelper.IncluirPermissoesViewHelper;

/**
 * @name IncluirPermissoesBean
 * @author Foursys
 * @version 1.0
 * @since 01/07/2020
 */
@SessionScoped
@Named(value = "incluirPermissoesBean")
public class IncluirPermissoesBean extends
AbstractBean<IncluirPermissoesViewHelper> {
	/**
	...
	public String iniciarPagina() {
		setViewHelper(new IncluirPermissoesViewHelper());
		viewHelper.inicializar();
		carregarListaInstrucoesVO();
		carregarListaMtVO();
		return RiccConstants.TELA_PARAMETRIZACAO_INCLUIR_PERMISSOES;
	}
