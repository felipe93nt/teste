...
import br.com.bradesco.web.ricc.view.bean.treinamento.equipes.equipe4.viewhelper.ConsultaQuestionarioImobiliarioEquipe4ViewHelper;

@SessionScoped
@Named(value = "consultaQuestionarioImobiliarioEquipe4Bean")
public class ConsultaQuestionarioImobiliarioEquipe4Bean extends AbstractBean<ConsultaQuestionarioImobiliarioEquipe4ViewHelper> {
	...
	public String iniciarPagina() {
		setViewHelper(new ConsultaQuestionarioImobiliarioEquipe4ViewHelper());
		viewHelper.inicializar();
		carregarDadosCadastro();
		carregarDados();
		
		return RiccConstants.TELA_EQUIPE4BEAN_CONSULTA_QUESTIONARIO_IMOBILIARIO;
	}
