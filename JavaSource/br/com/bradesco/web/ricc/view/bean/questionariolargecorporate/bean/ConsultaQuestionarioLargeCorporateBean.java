...
@SessionScoped
@Named(value = "consultaQuestionarioLargeCorporateBean")
public class ConsultaQuestionarioLargeCorporateBean extends AbstractBean<ConsultaQuestionarioLargeCorporateViewHelper> {
	...
	public String iniciarPagina() {
		...
		return RiccConstants.TELA_CONSULTA_QUESTIONARIO_LARGE_CORPORATE;
	}
	...
	public String consultarSetor() {
		...
		try {
			...
			String paginaAnterior = RiccConstants.TELA_CONSULTA_QUESTIONARIO_LARGE_CORPORATE;
