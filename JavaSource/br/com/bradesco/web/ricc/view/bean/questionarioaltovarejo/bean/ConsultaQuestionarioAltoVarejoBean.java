...
@SessionScoped
@Named(value = "consultaQuestionarioAltoVarejoBean")
public class ConsultaQuestionarioAltoVarejoBean extends AbstractBean<ConsultaAltoVarejoViewHelper>{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2725604575174726605L;
	private ConsultaAltoVarejoViewHelper viewHelper = null;
	...
	public String iniciarPagina() {
		...
		return RiccConstants.TELA_CONSULTA_QUESTIONARIO_ALTOVAREJO;
	}

	public ConsultaAltoVarejoViewHelper getViewHelper() {
		return viewHelper;
	}

	public void setViewHelper(ConsultaAltoVarejoViewHelper viewHelper) {
	...
	public void listarSetor() {
		...
		try {
			...
			if(!e.getMessage().equals(RiccConstants.MAINFRAME_CONSULTA_VAZIA)){
				BradescoFacesUtils.addErrorModalMessage(e.getCause().getMessage(),
						null, BradescoViewExceptionActionType.ACTION);
			}
		}
	}
	...
	public String consultarSetor() {
		try {
			...
			String retorno = "";
			String paginaAnterior = RiccConstants.TELA_CONSULTA_QUESTIONARIO_ALTOVAREJO;
