...
import br.com.bradesco.web.ricc.view.bean.parametrizacaomensagem.viewhelper.FormatosMensagemViewHelper;

/**
 * @name FormatosMensagemBean
 * @author Foursys
 * @version 1.0
 * @since 23/06/2020
 */
@SessionScoped
@Named(value = "formatosMensagemBean")
public class FormatosMensagemBean extends
		AbstractBean<FormatosMensagemViewHelper> {
	...
	public String iniciarPagina() {
		setViewHelper(new FormatosMensagemViewHelper());
		viewHelper.inicializar();
		carregarCamposIntegrantesVO();
		carregarCamposVO();
		return RiccConstants.TELA_PARAMETRIZACAO_FORMATOS_MENSAGEM;
	}
