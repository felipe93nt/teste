...
import br.com.bradesco.web.ricc.view.bean.treinamento.pedro.viewhelper.PedroSwrmViewHelper;
 ...
 */
@SessionScoped
@Named(value = "pedroSwrmBean")
public class PedroSwrmBean extends AbstractBean<PedroSwrmViewHelper> {
	/**
	 *
	 */
	...
	public String iniciarPagina() {
		this.viewHelper = new PedroSwrmViewHelper();
		this.viewHelper.inicializar();
		return RiccConstants.TELA_TREINAMENTO_SWRM_TESTE;
	}
	...
	public void limparCampos() {
		PedroSwrmViewHelper model = this.viewHelper;
		model.setNome(VAZIO);
		model.setCpf(VAZIO);
		model.setRg(VAZIO);
