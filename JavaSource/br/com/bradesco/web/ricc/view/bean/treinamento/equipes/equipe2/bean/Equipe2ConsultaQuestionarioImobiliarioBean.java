...
@SessionScoped
@Named(value = "equipe2ConsultaQuestionarioImobiliarioBean")
public class Equipe2ConsultaQuestionarioImobiliarioBean extends AbstractBean<ConsultaQuestionarioImobiliarioViewHelper> {
	...
	public String iniciarPagina() {
		...
		return RiccConstants.TELA_CONSULTA_QUESTIONARIO_IMOBILIARIO_EQUIPE2;
	}
	
	private void carregarDadosCadastro() {
		viewHelper.getModel().setCodGrupoEconomico(RiccConstants.TELA_CONSULTA_QUESTIONARIO_EMPRESAS_EQUIPE2_CODGRUPO);
		viewHelper.getModel().setDescGrupoEconomico(RiccConstants.TELA_CONSULTA_QUESTIONARIO_EMPRESAS_EQUIPE2_NOMEGRUPO);
		viewHelper.getModel().setCodRelatorio(RiccConstants.TELA_CONSULTA_QUESTIONARIO_EMPRESAS_EQUIPE2_CODRELATORIO);
	}
