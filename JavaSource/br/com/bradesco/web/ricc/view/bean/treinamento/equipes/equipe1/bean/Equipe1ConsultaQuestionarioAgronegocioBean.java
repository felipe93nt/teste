...
import br.com.bradesco.web.ricc.view.bean.treinamento.equipes.equipe1.viewhelper.Equipe1ConsultaQuestionarioAgronegocioViewHelper;

/**
 * @name Equipe1ConsultaQuestionarioAgronegocioBean
 * @author Equipe 1 - André Nunes, Isaac Maciel, João Carlos e João Gil
 * @see Equipe1ConsultaQuestionarioAgronegocioViewHelper.java
 * @version 1.0
 * @since 11/05/2020
 */
@SessionScoped
@Named(value = "equipe1ConsultaQuestionarioAgronegocioBean")
public class Equipe1ConsultaQuestionarioAgronegocioBean extends AbstractBean<Equipe1ConsultaQuestionarioAgronegocioViewHelper> {
private static final long serialVersionUID = 1L;
	...
	public String iniciarPagina() {
		...
		setViewHelper(new Equipe1ConsultaQuestionarioAgronegocioViewHelper());
		viewHelper.inicializar();
		
		return RiccConstants.TREINAMENTO_EQUIPE1_CONSULTA_CORPORATE_AGRONEGOCIO;
	}
