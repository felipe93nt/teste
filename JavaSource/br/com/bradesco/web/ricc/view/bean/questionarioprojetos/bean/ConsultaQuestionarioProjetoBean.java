...
import br.com.bradesco.web.ricc.view.bean.questionarioprojetos.viewhelper.ConsultaQuestionarioProjetoViewHelper;


@SessionScoped
@Named(value = "consultaQuestionarioProjetoBean")
public class ConsultaQuestionarioProjetoBean extends AbstractBean<ConsultaQuestionarioProjetoViewHelper> {
	...
	public String iniciarPagina() {
		setViewHelper(new ConsultaQuestionarioProjetoViewHelper());
		viewHelper.inicializar();
		
		return RiccConstants.TELA_CONSULTA_QUESTIONARIO_PROJETO;
	}
