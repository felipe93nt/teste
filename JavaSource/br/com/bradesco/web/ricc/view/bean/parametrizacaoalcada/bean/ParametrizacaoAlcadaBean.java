...
import br.com.bradesco.web.ricc.view.bean.parametrizacaoalcada.viewhelper.ParametrizacaoAlcadaViewHelper;
 ...
 */
@SessionScoped
@Named(value = "parametrizacaoAlcadaBean")
public class ParametrizacaoAlcadaBean extends
		AbstractBean<ParametrizacaoAlcadaViewHelper> {
	...
	public String iniciarPagina() {
		setViewHelper(new ParametrizacaoAlcadaViewHelper());
