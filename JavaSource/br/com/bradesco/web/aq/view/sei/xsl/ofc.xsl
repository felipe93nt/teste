...
<xsl:template match="/">
<xsl:text disable-output-escaping="yes"><![CDATA[<OFC>
  <DTD>2
  <CPAGE>1252]]></xsl:text>
...
<![CDATA[      <ACCTTYPE>0
    ...
    <STMTRS>
      <DTSTART>]]></xsl:text>
	  <xsl:text>20090518</xsl:text>
	  
<xsl:text disable-output-escaping="yes">
<![CDATA[      <DTEND>]]></xsl:text>
		<xsl:text>20090520</xsl:text>
		
<xsl:text disable-output-escaping="yes">
<![CDATA[      <LEDGER>]]></xsl:text>
 <xsl:value-of select="translate(translate(html/body/div/div[2]/div/div/table/tbody[2]/tr/td[10],'.',''),',','.')" />
...
<![CDATA[<DTPOSTED>]]></xsl:text>
		...
		<xsl:text disable-output-escaping="yes">
<![CDATA[<TRNAMT>]]></xsl:text>
		<xsl:value-of select="translate(translate(html/body/div/div[2]/div/div/div/div[2]/table/tbody/tr/td[10],'.',''),',','.')" />
...
<![CDATA[<DTPOSTED>]]></xsl:text>
		...
		<xsl:text disable-output-escaping="yes">
<![CDATA[<TRNAMT>]]></xsl:text>
		<xsl:value-of select="translate(translate(html/body/div/div[2]/div/div/div/div[2]/table/tbody/tr[2]/td[8],'.',''),',','.')" />
...
<![CDATA[<DTPOSTED>]]></xsl:text>
		...
		<xsl:text disable-output-escaping="yes">
<![CDATA[<TRNAMT>]]></xsl:text>
		<xsl:value-of select="translate(translate(html/body/div/div[2]/div/div/div/div[2]/table/tbody/tr[3]/td[8],'.',''),',','.')" />
...
<![CDATA[<DTPOSTED>]]></xsl:text>
		...
		<xsl:text disable-output-escaping="yes">
<![CDATA[<TRNAMT>]]></xsl:text>
		<xsl:value-of select="translate(translate(html/body/div/div[2]/div/div/div/div[2]/table/tbody/tr[4]/td[6],'.',''),',','.')" />
