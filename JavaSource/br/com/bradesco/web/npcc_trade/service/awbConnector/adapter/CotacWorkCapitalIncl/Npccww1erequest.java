 ...
 */
public class Npccww1erequest extends AnnotatedAdapter {

	@Adapter(transactionField = "NPCCWW1E-HEADER.NPCCWW1E-COD-LAYOUT")
	private String codlayout = "NPCCWW1E";

	@Adapter(transactionField = "NPCCWW1E-HEADER.NPCCWW1E-TAM-LAYOUT")
	private Integer tamlayout = 1296;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CADITV-BLETO-CMBIO")
	private Integer caditvbletocmbio = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CUNIC-CLI-CMBIO")
	private Long cunicclicmbio = 0L;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CPSSOA-JURID")
	private Long cpssoajurid = 0L;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-NSEQ-UND-ORGNZ")
	private Integer nsequndorgnz = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CTPO-SGMTO-CLI")
	private Integer ctposgmtocli = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CSIT-BLETO-CMBIO")
	private Integer csitbletocmbio = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CPRODT-SERVC")
	private Integer cprodtservc = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-NSEQ-CONTR-LIM")
	private Long nseqcontrlim = 0L;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CPSSOA-ANLSE-CREDT")
	private Long cpssoaanlsecredt = 0L;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-DANO-SOLTC-ANLSE")
	private Integer danosoltcanlse = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-NSOLTC-ANLSE-CREDT")
	private Long nsoltcanlsecredt = 0L;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-NSEQ-SOLTC-ANLSE")
	private Integer nseqsoltcanlse = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CINDCD-ECONM-MOEDA")
	private Integer cindcdeconmmoeda = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-VNEGOC-MOEDA-ESTRG")
	private String vnegocmoedaestrg = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CECONM-MOEDA-LIM")
	private Integer ceconmmoedalim = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CRTING")
	private String crting = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CMODLD-PRODT-CMBIO")
	private Integer cmodldprodtcmbio = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-NPPSTA-PONTU-CMBIO")
	private Long nppstapontucmbio = 0L;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-NCTA-BCRIA-CMBIO")
	private Integer nctabcriacmbio = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CTPO-NEGOC-CMBIO")
	private Integer ctponegoccmbio = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-TDIA-OPER-CMBIO")
	private Integer tdiaopercmbio = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-VMOEDA-LIM-GERC")
	private String vmoedalimgerc = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CECONM-MOEDA-DSEMB")
	private Integer ceconmmoedadsemb = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CINDCD-NEGOC-SWAP")
	private String cindcdnegocswap = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CINDCD-NEGOC-LIBOR")
	private String cindcdnegoclibor = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CNEGOC-SWAP-FLUXO")
	private String cnegocswapfluxo = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CNEGOC-SWAP-ESTRG")
	private String cnegocswapestrg = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CTPO-COTAC-TX")
	private Integer ctpocotactx = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-PTX-SWAP-CMPDO")
	private String ptxswapcmpdo = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CINDCD-NEGOC-CARTA")
	private String cindcdnegoccarta = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-TDIA-VALDD-LETRA")
	private Integer tdiavalddletra = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-DVALDD-NEGOC-CMBIO")
	private String dvalddnegoccmbio = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CCOMIS-CARTA-NACIO")
	private String ccomiscartanacio = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CINDCD-NEGOC-ARBTR")
	private String cindcdnegocarbtr = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-QPRZ-MED-CMBIO")
	private Integer qprzmedcmbio = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-VTRAVA-LIBOR-CMBIO")
	private String vtravaliborcmbio = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-VIMPST-NEGOC-CMBIO")
	private String vimpstnegoccmbio = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-VIOF-NEGOC-CMBIO")
	private String viofnegoccmbio = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-VTX-MORA-CMBIO")
	private String vtxmoracmbio = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-VTX-SPREAD-NEGOC")
	private String vtxspreadnegoc = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CBASE-JURO-MORA")
	private Integer cbasejuromora = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-VMULTA-NEGOC-CMBIO")
	private String vmultanegoccmbio = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CSEGUR-TRNSP-MCADO")
	private String csegurtrnspmcado = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CSEGUR-MCADO-ORGNZ")
	private String csegurmcadoorgnz = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-CMOD-CONTR-CMBIO")
	private Integer cmodcontrcmbio = 0;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-DPREVT-DSEMB-CMBIO")
	private String dprevtdsembcmbio = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-RJUSTF-DQMTO")
	private String rjustfdqmto = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-DPREVT-EMBRQ")
	private String dprevtembrq = null;

	@Adapter(transactionField = "NPCCWW1E-REGISTRO.NPCCWW1E-VTX-SPREAD-TOT")
