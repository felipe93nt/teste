 ...
 */
public class Npccwzksresponse_lista extends AnnotatedAdapter {

	@Adapter(transactionField = "NPCCWZKS-REGISTRO.NPCCWZKS-LISTA.NPCCWZKS-CPSSOA-JURID-SUBR")
	private Long lista_cpssoajuridsubr = 0L;

	@Adapter(transactionField = "NPCCWZKS-REGISTRO.NPCCWZKS-LISTA.NPCCWZKS-NSEQ-UND-SUBR")
	private Integer lista_nsequndsubr = 0;

	@Adapter(transactionField = "NPCCWZKS-REGISTRO.NPCCWZKS-LISTA.NPCCWZKS-CIDTFD-TPO-UND-SUBR")
	private Integer lista_cidtfdtpoundsubr = 0;

	@Adapter(transactionField = "NPCCWZKS-REGISTRO.NPCCWZKS-LISTA.NPCCWZKS-CRCONH-UND-SUBR-M")
	private String lista_crconhundsubrm = null;

	@Adapter(transactionField = "NPCCWZKS-REGISTRO.NPCCWZKS-LISTA.NPCCWZKS-CRCONH-UND-SUBR-F")
	private String lista_crconhundsubrf = null;

	@Adapter(transactionField = "NPCCWZKS-REGISTRO.NPCCWZKS-LISTA.NPCCWZKS-IRZ-SCIAL-SUBR")
	private String lista_irzscialsubr = null;

	@Adapter(transactionField = "NPCCWZKS-REGISTRO.NPCCWZKS-LISTA.NPCCWZKS-CTPO-UND-ORGNZ-SUBR")
	private Integer lista_ctpoundorgnzsubr = 0;

	@Adapter(transactionField = "NPCCWZKS-REGISTRO.NPCCWZKS-LISTA.NPCCWZKS-ITPO-UND-ORGNZ-SUBR")
