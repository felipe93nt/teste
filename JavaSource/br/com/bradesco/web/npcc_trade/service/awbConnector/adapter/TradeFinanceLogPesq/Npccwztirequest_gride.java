 ...
 */
public class Npccwztirequest_gride extends AnnotatedAdapter {

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-DT-COTACAO")
	private String gride_sdtcotacao = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-HORARIO")
	private String gride_shorario = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-NBLETO-CMBIO-ANO")
	private Long gride_snbletocmbioano = 0L;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CSIT-BLETO-CMBIO")
	private Integer gride_scsitbletocmbio = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-DSIT-BLETO-CMBIO")
	private String gride_sdsitbletocmbio = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-NSEQ-UND-ORGNZ")
	private Integer gride_snsequndorgnz = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-NOME-UND-ORGNZ")
	private String gride_snomeundorgnz = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CAG-BCRIA")
	private Integer gride_scagbcria = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CCTA-BCRIA-CMBIO")
	private Long gride_scctabcriacmbio = 0L;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-DIGT-CCTA-BCRIA")
	private String gride_sdigtcctabcria = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CPRODT-SERVC")
	private Integer gride_scprodtservc = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-DPRODT-SERVC")
	private String gride_sdprodtservc = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CMODLD-PRODT-CMBIO")
	private Integer gride_scmodldprodtcmbio = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CMODLD-PRODT-DESC")
	private String gride_scmodldprodtdesc = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CUNIC-CLI-CMBIO")
	private Long gride_scunicclicmbio = 0L;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-NCUNIC-CLI-CMBIO")
	private String gride_sncunicclicmbio = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-TP-PESSOA")
	private String gride_stppessoa = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CPF-CNPJ")
	private Integer gride_scpfcnpj = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CFLIAL")
	private Integer gride_scflial = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CCTRL")
	private Integer gride_scctrl = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CRTING")
	private String gride_scrting = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CTPO-SGMTO-CLI")
	private Integer gride_sctposgmtocli = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-DTPO-SGMTO-CLI")
	private String gride_sdtposgmtocli = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CINDCD-ECONM-MOEDA")
	private Integer gride_scindcdeconmmoeda = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-SIMBL-ECONM-MOEDA")
	private String gride_ssimbleconmmoeda = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-VNEGOC-MOEDA-ESTRG")
	private Double gride_svnegocmoedaestrg = 0D;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-VTX-SPREAD-NEGOC")
	private Double gride_svtxspreadnegoc = 0D;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-TDIA-OPER-CMBIO")
	private Integer gride_stdiaopercmbio = 0;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-CUSUAR-INCLT")
	private String gride_scusuarinclt = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-NUSUAR-INCLT")
	private String gride_snusuarinclt = null;

	@Adapter(transactionField = "NPCCWZTI-REGISTRO.NPCCWZTI-GRIDE.NPCCWZTI-S-NBLETO-NEGOC-CMBIO")
	...
	public Double getGride_svnegocmoedaestrg() {
		return gride_svnegocmoedaestrg;
	}
	public void setGride_svnegocmoedaestrg(Double gride_svnegocmoedaestrg) {
		this.gride_svnegocmoedaestrg = gride_svnegocmoedaestrg;
	}

	public Double getGride_svtxspreadnegoc() {
		return gride_svtxspreadnegoc;
	}
	public void setGride_svtxspreadnegoc(Double gride_svtxspreadnegoc) {
