 ...
 */
public class Npccwv3erequest extends AnnotatedAdapter {

	@Adapter(transactionField = "NPCCWV3E-HEADER.NPCCWV3E-COD-LAYOUT")
	private String codlayout = "NPCCWV3E";

	@Adapter(transactionField = "NPCCWV3E-HEADER.NPCCWV3E-TAM-LAYOUT")
	private Integer tamlayout = 1296;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CADITV-BLETO-CMBIO")
	private Integer caditvbletocmbio = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CUNIC-CLI-CMBIO")
	private Long cunicclicmbio = 0L;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CPSSOA-JURID")
	private Long cpssoajurid = 0L;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-NSEQ-UND-ORGNZ")
	private Integer nsequndorgnz = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CTPO-SGMTO-CLI")
	private Integer ctposgmtocli = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CSIT-BLETO-CMBIO")
	private Integer csitbletocmbio = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CPRODT-SERVC")
	private Integer cprodtservc = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-NSEQ-CONTR-LIM")
	private Long nseqcontrlim = 0L;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CPSSOA-ANLSE-CREDT")
	private Long cpssoaanlsecredt = 0L;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-DANO-SOLTC-ANLSE")
	private Integer danosoltcanlse = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-NSOLTC-ANLSE-CREDT")
	private Long nsoltcanlsecredt = 0L;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-NSEQ-SOLTC-ANLSE")
	private Integer nseqsoltcanlse = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CINDCD-ECONM-MOEDA")
	private Integer cindcdeconmmoeda = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-VNEGOC-MOEDA-ESTRG")
	private String vnegocmoedaestrg = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CECONM-MOEDA-LIM")
	private Integer ceconmmoedalim = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CRTING")
	private String crting = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CMODLD-PRODT-CMBIO")
	private Integer cmodldprodtcmbio = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-NPPSTA-PONTU-CMBIO")
	private Long nppstapontucmbio = 0L;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-NCTA-BCRIA-CMBIO")
	private Integer nctabcriacmbio = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CTPO-NEGOC-CMBIO")
	private Integer ctponegoccmbio = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-TDIA-OPER-CMBIO")
	private Integer tdiaopercmbio = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-VMOEDA-LIM-GERC")
	private String vmoedalimgerc = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CECONM-MOEDA-DSEMB")
	private Integer ceconmmoedadsemb = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CINDCD-NEGOC-SWAP")
	private String cindcdnegocswap = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CINDCD-NEGOC-LIBOR")
	private String cindcdnegoclibor = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CNEGOC-SWAP-FLUXO")
	private String cnegocswapfluxo = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CNEGOC-SWAP-ESTRG")
	private String cnegocswapestrg = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CTPO-COTAC-TX")
	private Integer ctpocotactx = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-PTX-SWAP-CMPDO")
	private String ptxswapcmpdo = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CINDCD-NEGOC-CARTA")
	private String cindcdnegoccarta = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-TDIA-VALDD-LETRA")
	private Integer tdiavalddletra = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-DVALDD-NEGOC-CMBIO")
	private String dvalddnegoccmbio = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CCOMIS-CARTA-NACIO")
	private String ccomiscartanacio = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CINDCD-NEGOC-ARBTR")
	private String cindcdnegocarbtr = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-QPRZ-MED-CMBIO")
	private Integer qprzmedcmbio = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-VTRAVA-LIBOR-CMBIO")
	private String vtravaliborcmbio = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-VIMPST-NEGOC-CMBIO")
	private String vimpstnegoccmbio = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-VIOF-NEGOC-CMBIO")
	private String viofnegoccmbio = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-VTX-MORA-CMBIO")
	private String vtxmoracmbio = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-VTX-SPREAD-NEGOC")
	private String vtxspreadnegoc = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CBASE-JURO-MORA")
	private Integer cbasejuromora = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-VMULTA-NEGOC-CMBIO")
	private String vmultanegoccmbio = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CSEGUR-TRNSP-MCADO")
	private String csegurtrnspmcado = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CSEGUR-MCADO-ORGNZ")
	private String csegurmcadoorgnz = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-CMOD-CONTR-CMBIO")
	private Integer cmodcontrcmbio = 0;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-DPREVT-DSEMB-CMBIO")
	private String dprevtdsembcmbio = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-RJUSTF-DQMTO")
	private String rjustfdqmto = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-DPREVT-EMBRQ")
	private String dprevtembrq = null;

	@Adapter(transactionField = "NPCCWV3E-REGISTRO.NPCCWV3E-VTX-SPREAD-TOT")
