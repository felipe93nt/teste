 ...
 */
public class Npccwv0erequest extends AnnotatedAdapter {

	@Adapter(transactionField = "NPCCWV0E-HEADER.NPCCWV0E-COD-LAYOUT")
	private String codlayout = "NPCCWV0E";

	@Adapter(transactionField = "NPCCWV0E-HEADER.NPCCWV0E-TAM-LAYOUT")
	private Integer tamlayout = 1296;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CADITV-BLETO-CMBIO")
	private Integer caditvbletocmbio = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CUNIC-CLI-CMBIO")
	private Long cunicclicmbio = 0L;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CPSSOA-JURID")
	private Long cpssoajurid = 0L;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-NSEQ-UND-ORGNZ")
	private Integer nsequndorgnz = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CTPO-SGMTO-CLI")
	private Integer ctposgmtocli = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CSIT-BLETO-CMBIO")
	private Integer csitbletocmbio = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CPRODT-SERVC")
	private Integer cprodtservc = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-NSEQ-CONTR-LIM")
	private Long nseqcontrlim = 0L;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CPSSOA-ANLSE-CREDT")
	private Long cpssoaanlsecredt = 0L;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-DANO-SOLTC-ANLSE")
	private Integer danosoltcanlse = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-NSOLTC-ANLSE-CREDT")
	private Long nsoltcanlsecredt = 0L;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-NSEQ-SOLTC-ANLSE")
	private Integer nseqsoltcanlse = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CINDCD-ECONM-MOEDA")
	private Integer cindcdeconmmoeda = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-VNEGOC-MOEDA-ESTRG")
	private String vnegocmoedaestrg = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CECONM-MOEDA-LIM")
	private Integer ceconmmoedalim = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CRTING")
	private String crting = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CMODLD-PRODT-CMBIO")
	private Integer cmodldprodtcmbio = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-NPPSTA-PONTU-CMBIO")
	private Long nppstapontucmbio = 0L;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-NCTA-BCRIA-CMBIO")
	private Integer nctabcriacmbio = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CTPO-NEGOC-CMBIO")
	private Integer ctponegoccmbio = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-TDIA-OPER-CMBIO")
	private Integer tdiaopercmbio = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-VMOEDA-LIM-GERC")
	private String vmoedalimgerc = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CECONM-MOEDA-DSEMB")
	private Integer ceconmmoedadsemb = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CINDCD-NEGOC-SWAP")
	private String cindcdnegocswap = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CINDCD-NEGOC-LIBOR")
	private String cindcdnegoclibor = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CNEGOC-SWAP-FLUXO")
	private String cnegocswapfluxo = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CNEGOC-SWAP-ESTRG")
	private String cnegocswapestrg = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CTPO-COTAC-TX")
	private Integer ctpocotactx = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-PTX-SWAP-CMPDO")
	private String ptxswapcmpdo = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CINDCD-NEGOC-CARTA")
	private String cindcdnegoccarta = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-TDIA-VALDD-LETRA")
	private Integer tdiavalddletra = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-DVALDD-NEGOC-CMBIO")
	private String dvalddnegoccmbio = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CCOMIS-CARTA-NACIO")
	private String ccomiscartanacio = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CINDCD-NEGOC-ARBTR")
	private String cindcdnegocarbtr = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-QPRZ-MED-CMBIO")
	private Integer qprzmedcmbio = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-VTRAVA-LIBOR-CMBIO")
	private String vtravaliborcmbio = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-VIMPST-NEGOC-CMBIO")
	private String vimpstnegoccmbio = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-VIOF-NEGOC-CMBIO")
	private String viofnegoccmbio = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-VTX-MORA-CMBIO")
	private String vtxmoracmbio = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-VTX-SPREAD-NEGOC")
	private String vtxspreadnegoc = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CBASE-JURO-MORA")
	private Integer cbasejuromora = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-VMULTA-NEGOC-CMBIO")
	private String vmultanegoccmbio = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CSEGUR-TRNSP-MCADO")
	private String csegurtrnspmcado = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CSEGUR-MCADO-ORGNZ")
	private String csegurmcadoorgnz = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-CMOD-CONTR-CMBIO")
	private Integer cmodcontrcmbio = 0;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-DPREVT-DSEMB-CMBIO")
	private String dprevtdsembcmbio = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-RJUSTF-DQMTO")
	private String rjustfdqmto = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-DPREVT-EMBRQ")
	private String dprevtembrq = null;

	@Adapter(transactionField = "NPCCWV0E-REGISTRO.NPCCWV0E-VTX-SPREAD-TOT")
