 ...
 */
public class Npccwwvsresponse_lista extends AnnotatedAdapter {

	@Adapter(transactionField = "NPCCWWVS-REGISTRO.NPCCWWVS-LISTA.NPCCWWVS-NPCELA-DSEMB-TRADE")
	private Integer lista_npceladsembtrade = 0;

	@Adapter(transactionField = "NPCCWWVS-REGISTRO.NPCCWWVS-LISTA.NPCCWWVS-TDIA-NEGOC-PCELA")
	private Integer lista_tdianegocpcela = 0;

	@Adapter(transactionField = "NPCCWWVS-REGISTRO.NPCCWWVS-LISTA.NPCCWWVS-DVCTO-PCELA-TRADE")
	private String lista_dvctopcelatrade = null;

	@Adapter(transactionField = "NPCCWWVS-REGISTRO.NPCCWWVS-LISTA.NPCCWWVS-VPCELA-MESA-TRADE")
	private String lista_vpcelamesatrade = null;

	@Adapter(transactionField = "NPCCWWVS-REGISTRO.NPCCWWVS-LISTA.NPCCWWVS-TP-PARCELA")
